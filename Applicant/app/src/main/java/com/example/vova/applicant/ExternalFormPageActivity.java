...
public class ExternalFormPageActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        switch (view.getId()){
            ...
            case R.id.buttonBachelorDegreeFullTimeFormPageActivity:
                ...
                Log.d("My", "FullTimeFormPageActivity -> onClick ->  mStrFullTimeLink \n" +
                        " + KEY_BACHELOR_FULL_TIME" +  mStrFullTimeLink + KEY_BACHELOR_EXTERNAL);
                Log.d("My", "FullTimeFormPageActivity -> onClick ->  mStrFullTimeName \n" +
                        " + KEY_BACHELOR_FULL_TIME" +  mStrFullTimeName + KEY_BACHELOR_EXTERNAL);
                break;
