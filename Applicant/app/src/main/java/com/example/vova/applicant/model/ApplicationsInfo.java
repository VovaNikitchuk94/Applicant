...
//    }
    ...
    public ApplicationsInfo(Cursor cursor) {
        ...
        mLongSpecialityId = cursor.getLong(cursor.getColumnIndex(ApplicationTable.Cols.APPLICATION_INFO_FIELD_SPECILITY_ID));
    ...
    public ContentValues getContentValues() {
        ...
        values.put(ApplicationTable.Cols.APPLICATION_INFO_FIELD_SPECILITY_ID, getLongSpecialityId());
